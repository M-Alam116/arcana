...
export default function Products() {
    return (
        <Wrapper style='py-[4rem]'>
            <div className="">
                <h2 className="text-[34px] text-white font-[500] leading-[48px] text-center max-w-[400px] mx-auto mb-[3rem]">Unparalleled liquidity. Rock solid products.</h2>
                <div className="flex flex-col gap-[1rem]">
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-[1rem]">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[1rem] bg-[#5099CC7A] rounded-[32px] lg:w-[58%]">
                        ...
                        <div className="bg-[#091620] lg:w-[42%] grid lg:grid-cols-3 rounded-[32px] relative">
                            <div className="p-[2rem] lg:col-span-2 flex flex-col gap-[1rem]">
                                ...
                                <button className='mt-[1rem] w-fit py-[8px] px-[12px] rounded-[12px] bg-[#5099CC14] text-white'>Start your own</button>
                            </div>
                            <div className="hidden lg:flex">
